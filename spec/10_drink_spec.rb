...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      subject(:default_drink) { described_class.new("bloody mary") }

      it 'is your choice of beverage' do
        expect(default_drink.type).to be("bloody mary")
      end
  ...
  describe '#full?' do
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:default_drink) { described_class.new("bloody mary", 7) }
